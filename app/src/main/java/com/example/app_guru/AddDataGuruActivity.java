...
public class AddDataGuruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_data_guru);
                            ...
                            databaseReference.child("Guru").child(firebaseUser.getUid()).setValue(userData)
                                    .addOnCompleteListener(dbTask -> {
                                        if (dbTask.isSuccessful()) {
                                            Toast.makeText(AddDataGuruActivity.this, "Pengguna berhasil ditambahkan", Toast.LENGTH_SHORT).show();
                                            resetInputFields();
                                        } else {
                                            Toast.makeText(AddDataGuruActivity.this, "Gagal menambahkan pengguna: " + dbTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    } else {
                        Toast.makeText(AddDataGuruActivity.this, "Gagal membuat pengguna: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
